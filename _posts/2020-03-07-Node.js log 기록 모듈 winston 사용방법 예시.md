...
### 결과
![콘솔 로그]({{ site.baseurl }}/public/images/{{ page.title }}/console.png){: width="90%" height="30%" style="margin:auto;"}  
**로그 파일 생성도 잘 된 것을 볼 수 있다**
![로그 파일]({{ site.baseurl }}/public/images/{{ page.title }}/file.png){: width="35%" height="25%"}
